"""
Cleanly update fetchStockData in app.js with console.log execution tracking
"""
...
if start_idx is not None:
    # Find matching closing brace for function block
    brace_count = 0
...
new_lines = lines[:start_idx] + new_fn_lines + lines[end_idx+1:]
with open('app.js', 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("Updated fetchStockData cleanly!")
